...
/**
 * Interface for metadata logging in structured streaming.
 * This is a local definition to replace the internal Spark MetadataLog
 * which is no longer publicly accessible in Spark 4.1.
 */
trait MetadataLog[T] {
