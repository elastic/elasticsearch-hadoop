...
When using Storm's internal ticks, remember to set the tick interval: builder.setBolt(...).addConfiguration(Config.TOPOLOGY_TICK_TUPLE_FREQ_SECS, 2) // tick every 2 seconds
