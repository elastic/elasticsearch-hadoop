...
{eh} automatically converts Hadoop built-in `Writable` types to {es} {ref}/mapping.html#all-mapping-types[types] (and back) as shown in the table below:
