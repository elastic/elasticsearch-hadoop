...
The general process of deploying {krb} and securing Hadoop is beyond the scope of this documentation.
...
done all the required steps for <<kerberos-hadoop-requirements,configuring your Hadoop cluster>> before using {krb}
