...
DataFrame people = JavaEsSpark SQL.esDF(sql, "spark/people");  <3>
----
...
[source,java]
----
DataFrame people = JavaEsSpark SQL.esDF(sql, "spark/people", "?q=Smith"  <1>); 
----
...
JavaSchemaRDD people = JavaEsSpark SQL.esRDD(jsql, "spark/people"); <3>
----
...
[source,java]
----
JavaSchemaRDD people = JavaEsSpark SQL.esRDD(jsql, "spark/people", "?q=Smith" <1>); 
----
