...
JavaPairRDD<String, Map<String, Object>> esRDD = JavaEsSpark.esRDD(jsc, "radio/artists"); <4>
----
...
...
JavaRDD<Map<String, Object>> esRDD = esRDD(jsc, "radio/artists", "?me*"<2>).values()<3>; 
----
...
[source, java]
----
JavaRDD<Map<String, Object>> esRDD = esRDD(jsc, "radio/artists", "?me*").values();
...
----
JavaRDD<Map<String, Object>> esRDD = esRDD(jsc, "radio/artists", "?me*").values();
JavaRDD<Map<String, Object>> filtered = esRDD.filter(doc -> doc.contains("mega"));
----
