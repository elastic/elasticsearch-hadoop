...
# exclude
es.mapping.include = *.description
----
...
in the document with the exception of any nested field named +descriptor+. Additionally the document parent will be +123+ while the
