...
public class RestServiceTest {
    ...
    public void setup() {
        ...
        pd1 = bldr.build(null, sh1.getIndex(), sh1.getName());
        pd2 = bldr.build(null, sh2.getIndex(), sh2.getName());
        pd3 = bldr.build(null, sh3.getIndex(), sh3.getName());
        pd4 = bldr.build(null, sh4.getIndex(), sh4.getName());
        pd5 = bldr.build(null, sh5.getIndex(), sh5.getName());
        pd6 = bldr.build(null, sh6.getIndex(), sh6.getName());
