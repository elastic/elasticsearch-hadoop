...
public class ApplyAliasMetaDataTest {
    ...
    public void testNoAlias() throws IOException {
        ...
        SearchRequestBuilder searchRequest = new SearchRequestBuilder(EsMajorVersion.LATEST, false);
        RestService.applyAliasMetadata(aliases, searchRequest, "index1", "alias1");
    ...
    public void testNoExplicitAlias() throws IOException {
        ...
        {
            SearchRequestBuilder searchRequest = new SearchRequestBuilder(EsMajorVersion.LATEST, false);
            RestService.applyAliasMetadata(aliases, searchRequest, "index1", "index1");
            assertNull(searchRequest.query());
            assertNull(searchRequest.routing());
        }
        ...
        {
            SearchRequestBuilder searchRequest = new SearchRequestBuilder(EsMajorVersion.LATEST, false);
            RestService.applyAliasMetadata(aliases, searchRequest, "index1", "_all");
            assertNull(searchRequest.query());
            assertNull(searchRequest.routing());
        }
        ...
        {
            SearchRequestBuilder searchRequest = new SearchRequestBuilder(EsMajorVersion.LATEST, false);
            RestService.applyAliasMetadata(aliases, searchRequest, "index1", "*");
            assertNull(searchRequest.query());
            assertNull(searchRequest.routing());
        }
        ...
        {
            SearchRequestBuilder searchRequest = new SearchRequestBuilder(EsMajorVersion.LATEST, false);
            RestService.applyAliasMetadata(aliases, searchRequest, "index1", "a*1", "index*");
            assertNull(searchRequest.query());
            assertNull(searchRequest.routing());
        }
        ...
        {
            SearchRequestBuilder searchRequest = new SearchRequestBuilder(EsMajorVersion.LATEST, false);
            RestService.applyAliasMetadata(aliases, searchRequest, "index1", "alias1", "+index1");
            assertNull(searchRequest.query());
            assertNull(searchRequest.routing());
        }
        ...
        {
            SearchRequestBuilder searchRequest = new SearchRequestBuilder(EsMajorVersion.LATEST, false);
            RestService.applyAliasMetadata(aliases, searchRequest, "index1", "alias1", "alias2", "*");
            assertNull(searchRequest.query());
            assertNull(searchRequest.routing());
        }
        ...
        {
            SearchRequestBuilder searchRequest = new SearchRequestBuilder(EsMajorVersion.LATEST, false);
            RestService.applyAliasMetadata(aliases, searchRequest, "index1", "alias1", "alias2", "_all");
            assertNull(searchRequest.query());
            assertNull(searchRequest.routing());
        }
    }
    ...
    public void testOneAlias() throws IOException {
        ...
        {
            SearchRequestBuilder searchRequest = new SearchRequestBuilder(EsMajorVersion.LATEST, false);
            RestService.applyAliasMetadata(aliases, searchRequest, "index1", "a*1");
            assertEquals(printQueryBuilder(searchRequest.query(), false),
                    printQueryBuilder(expected, false));
            assertEquals(searchRequest.routing(), "1,2");
        }
        ...
        {
            SearchRequestBuilder searchRequest = new SearchRequestBuilder(EsMajorVersion.LATEST, false);
            RestService.applyAliasMetadata(aliases, searchRequest, "index1", "alias*", "-alias2");
            assertEquals(printQueryBuilder(searchRequest.query(), false),
                    printQueryBuilder(expected, false));
            assertEquals(searchRequest.routing(), "1,2");
        }
        ...
        {
            SearchRequestBuilder searchRequest = new SearchRequestBuilder(EsMajorVersion.LATEST, false);
            RestService.applyAliasMetadata(aliases, searchRequest, "index1", "+alias1", "+alias2", "-alias2");
            assertEquals(printQueryBuilder(searchRequest.query(), false),
                    printQueryBuilder(expected, false));
            assertEquals(searchRequest.routing(), "1,2");
        }
