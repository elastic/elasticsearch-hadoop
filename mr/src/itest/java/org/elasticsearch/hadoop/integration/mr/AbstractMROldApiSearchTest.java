...
public class AbstractMROldApiSearchTest {
    ...
    public void testDynamicPattern() throws Exception {
        ...
        Assert.assertTrue(RestUtils.exists("mroldapi-pattern-500/data"));
        Assert.assertTrue(RestUtils.exists("mroldapi-pattern-990/data"));
    }

    @Test
    public void testDynamicPatternWithFormat() throws Exception {
        Assert.assertTrue(RestUtils.exists("mroldapi-pattern-format-2936-10-06/data"));
        Assert.assertTrue(RestUtils.exists("mroldapi-pattern-format-2051-10-06/data"));
        Assert.assertTrue(RestUtils.exists("mroldapi-pattern-format-2945-10-06/data"));
    }
