...
public class DeserializationHandlerLoader extends HandlerLoader<DeserializationErrorHandler> {
    ...
    @Override
    protected DeserializationErrorHandler loadBuiltInHandler(NamedHandlers handlerName) {
        switch (handlerName) {
            case FAIL:
